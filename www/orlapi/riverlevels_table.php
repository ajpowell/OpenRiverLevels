...
$sql = "select sit.sitename, sit.watercourse, lev.level, date_format(lev.read_dt, '%H:%i %e/%m/%Y') reading_time from levels lev join sites sit on sit.siteid = lev.siteid where sit.siteid=7051 order by sit.sitename, read_dt";
